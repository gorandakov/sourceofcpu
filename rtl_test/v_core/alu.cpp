...
void req_set(Vheptane_core *top,req *reqs,char *mem,char *memp) {
    ...
    if (top->heptane_core__DOT__bck_mod__DOT__agu_aligned__DOT__mOpX3_addrOdd_reg==0x200074 && top->heptane_core__DOT__bck_mod__DOT__agu_aligned__DOT__mOpX3_en_reg) {
	printf(" ");
    }
