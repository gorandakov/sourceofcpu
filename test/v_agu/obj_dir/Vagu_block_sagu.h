...
VL_MODULE(Vagu_block_sagu) {
  public:
    ...
    // Begin mtask footprint all: 10 11 26 
    CData/*7:0*/ __PVT__WQ_no_reg;
    CData/*0:0*/ __PVT__lsflag_reg;
    // Begin mtask footprint all: 5 10 11 
    ...
    // Begin mtask footprint all: 1 5 7 
    CData/*0:0*/ __PVT__tlb_clkEn;
    // Begin mtask footprint all: 1 5 7 26 
    ...
    CData/*0:0*/ mOp_split__out__en8;
    // Begin mtask footprint all: 10 11 
    SData/*13:0*/ __pinNumber3__en0;
    SData/*13:0*/ addrNext__out10;
  ...
  public:
    ...
    void _combo__TOP__agu_block__DOT__Wagu_mod__83(Vagu_block__Syms* __restrict vlSymsp);
  private:
    void _ctor_var_reset() VL_ATTR_COLD;
  public:
    void _sequent__TOP__agu_block__DOT__Wagu_mod__82(Vagu_block__Syms* __restrict vlSymsp);
